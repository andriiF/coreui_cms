...
<script>
import AngularImg from '@/admin/assets/images/angular.jpg'
import ReactImg from '@/admin/assets/images/react.jpg'
import VueImg from '@/admin/assets/images/vue.jpg'
export default {
  name: 'Carousels',
  setup() {
    return {
